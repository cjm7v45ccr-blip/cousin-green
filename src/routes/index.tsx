      ...
      <section className="px-4 py-24 bg-background">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              { src: beforeAfter1.url, alt: "Before and after of a roadside landscape bed: dry mulch transformed into a clean river-rock bed with thriving ornamental grass." },
              { src: beforeAfter2.url, alt: "Before and after of a backyard: bare dirt and debris transformed into a freshly installed, manicured sod lawn." },
            ].map((img) => (
